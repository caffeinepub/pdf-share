...
import type { ExternalBlob as _ExternalBlob, Metadata as _Metadata, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deletePdf(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async finalizeUpload(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.finalizeUpload(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPdf(arg0: string): Promise<Metadata> {
        if (this.processError) {
            try {
                const result = await this.actor.getPdf(arg0);
                return from_candid_Metadata_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPdfChunk(arg0: string, arg1: ChunkIndex): Promise<Chunk> {
        if (this.processError) {
            try {
                const result = await this.actor.getPdfChunk(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPdfChunks(arg0: string): Promise<ChunkInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getPdfChunks(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async kickUser(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async listBannedUsers(): Promise<Array<Principal>> {
        if (this.processError) {
            try {
                const result = await this.actor.listBannedUsers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listPdfs(): Promise<Array<Metadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.listPdfs();
    ...
    async startUpload(arg0: UploadParams): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.startUpload(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePdfTitle(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePdfTitle(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadChunk(arg0: string, arg1: bigint, arg2: Chunk): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_Metadata_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Metadata): Promise<Metadata> {
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Metadata>): Promise<Array<Metadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Metadata_n14(_uploadFile, _downloadFile, x)));
}
